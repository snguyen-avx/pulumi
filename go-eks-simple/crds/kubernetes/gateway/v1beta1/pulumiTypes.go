...
type GatewaySpec struct {
	...
	//      TLS Profile
	//  2. TLSRoute, Port: 443, Protocol: TLS, TLS Mode: Passthrough
	...
	//  4. They are distinct. 2. The implementation can serve them in compliance with the Addresses requirement that all Listeners are available on all assigned addresses.
